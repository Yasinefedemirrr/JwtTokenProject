...
namespace JWTAPI.Controllers
{
    ...
    public class CityWeathersController : ControllerBase
    {
        ...
        public CityWeathersController(CreateCityWeatherCommandHandler createCityWeatherCommandHandler, GetCityWeatherByIdQueryHandler getCityWeatherByIdQueryHandler, GetCityWeatherQueryHandler getCityWeatherQueryHandler, UpdateCityWeatherCommandHandler updateCityWeatherCommandHandler, RemoveCityWeatherCommandHandler removeCityWeatherCommandHandler)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreatCityWeather(CreateCityWeatherCommand command)
        {
            await _createCityWeatherCommandHandler.Handle(command);
            return Ok("Hava durumu bilgisi Bilgisi Eklendi");
        }
        ...
        public async Task<IActionResult> RemoveCityWeather(int id)
        {
            ...
            return Ok("Hava durumu bilgisi Bilgisi Silindi");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateCityWeather(UpdateCityWeatherCommand command)
        {
            ...
            return Ok("Hava durumu bilgisi Bilgisi Güncellendi");
        }
