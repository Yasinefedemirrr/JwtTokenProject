...
namespace Persistance.Migrations
{
    ...
    [Migration("20250718074331_mig_add_2233190")]
    partial class mig_add_2233190
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JWT.Domain.Entity.District", b =>
                {
                    ...
                    b.Property<int>("CityWeatherCityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JWT.Domain.Entity.District", b =>
                {
                    b.HasOne("JWT.Domain.Entity.CityWeather", "CityWeather")
                        .WithMany("Districts")
                        .HasForeignKey("CityWeatherCityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
